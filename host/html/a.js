!(function (e, t) {
    ...
    function u(e) {
        var t = e.id;
        return r(r({}, e), { id: a(t), transports: e.transports });
    }
    function s(e) {
    ...
    var d = new ((function () {
        function e() {}
        return (
            (e.prototype.createNewAbortSignal = function () {
            ...
            return (
                ...
                n(this, void 0, void 0, function () {
                    ...
                    return o(this, function (o) {
                        switch (o.label) {
                            case 0:
                                if (!l()) throw new Error("WebAuthn is not supported in this browser");
                                return (
                                    0 !== (null === (p = e.allowCredentials) || void 0 === p ? void 0 : p.length) && (n = null === (h = e.allowCredentials) || void 0 === h ? void 0 : h.map(u)),
                                    (w = r(r({}, e), { challenge: a(e.challenge), allowCredentials: n })),
                                    (b = {}),
                                    t ? [4, f()] : [3, 2]
                                );
                            case 1:
                                if (!o.sent()) throw Error("Browser does not support WebAuthn autofill");
                                if (document.querySelectorAll("input[autocomplete*='webauthn']").length < 1) throw Error('No <input> with `"webauthn"` in its `autocomplete` attribute was detected');
                                (b.mediation = "conditional"), (w.allowCredentials = []), (o.label = 2);
                            case 2:
                                (b.publicKey = w), (b.signal = d.createNewAbortSignal()), (o.label = 3);
                            case 3:
                                return o.trys.push([3, 5, , 6]), [4, navigator.credentials.get(b)];
                            case 4:
                                return (y = o.sent()), [3, 6];
                            case 5:
                                throw (function (e) {
                                    ...
                                    if ("AbortError" === r.name) {
                                        if (n.signal === new AbortController().signal) return new c("Authentication ceremony was sent an abort signal", "AbortError");
                                    } else {
                                        if ("NotAllowedError" === r.name)
                                            return (null === (t = o.allowCredentials) || void 0 === t ? void 0 : t.length)
                                                ? new c("No available authenticator recognized any of the allowed credentials", "NotAllowedError")
                                                : new c("User clicked cancel, or the authentication ceremony timed out", "NotAllowedError");
                                        if ("SecurityError" === r.name) {
                                            var i = window.location.hostname;
                                            if (!s(i)) return new c("".concat(window.location.hostname, " is an invalid domain"), "SecurityError");
                                            if (o.rpId !== i) return new c('The RP ID "'.concat(o.rpId, '" is invalid for this domain'), "SecurityError");
                                        } else if ("UnknownError" === r.name) return new c("The authenticator was unable to process the specified options, or could not create a new assertion signature", "UnknownError");
                                    }
                                    return r;
                                })({ error: o.sent(), options: b });
                            case 6:
                                if (!y) throw new Error("Authentication was not completed");
                                return (
                                    (v = y.id),
                                    (g = y.rawId),
                                    (m = y.response),
                                    (E = y.type),
                                    (A = void 0),
                                    m.userHandle && ((S = m.userHandle), (A = new TextDecoder("utf-8").decode(S))),
                                    [
                                        2,
                                        {
                                            id: v,
                                            rawId: i(g),
                                            response: { authenticatorData: i(m.authenticatorData), clientDataJSON: i(m.clientDataJSON), signature: i(m.signature), userHandle: A },
                                            type: E,
            ...
            return n(this, void 0, void 0, function () {
                ...
                return o(this, function (o) {
                    switch (o.label) {
                        case 0:
                            if (!l()) throw new Error("WebAuthn is not supported in this browser");
                            (t = r(r({}, e), { challenge: a(e.challenge), user: r(r({}, e.user), { id: ((v = e.user.id), new TextEncoder().encode(v)) }), excludeCredentials: e.excludeCredentials.map(u) })),
                                ((n = { publicKey: t }).signal = d.createNewAbortSignal()),
                                (o.label = 1);
                        case 1:
                            return o.trys.push([1, 3, , 4]), [4, navigator.credentials.create(n)];
                        case 2:
                            return (f = o.sent()), [3, 4];
                        case 3:
                            throw (function (e) {
                                ...
                                if ("AbortError" === n.name) {
                                    if (o.signal === new AbortController().signal) return new c("Registration ceremony was sent an abort signal", "AbortError");
                                    ...
                                    if ("InvalidStateError" === n.name) return new c("The authenticator was previously registered", "InvalidStateError");
                                    if ("NotAllowedError" === n.name) return new c("User clicked cancel, or the registration ceremony timed out", "NotAllowedError");
                                    if ("NotSupportedError" === n.name)
                                        return 0 ===
                                            i.pubKeyCredParams.filter(function (e) {
                                                return "public-key" === e.type;
                                            }).length
                                            ? new c('No entry in pubKeyCredParams was of type "public-key"', "NotSupportedError")
                                            : new c("No available authenticator supported any of the specified pubKeyCredParams algorithms", "NotSupportedError");
                                    if ("SecurityError" === n.name) {
                                        var a = window.location.hostname;
                                        if (!s(a)) return new c("".concat(window.location.hostname, " is an invalid domain"), "SecurityError");
                                        if (i.rp.id !== a) return new c('The RP ID "'.concat(i.rp.id, '" is invalid for this domain'), "SecurityError");
                                    } else if ("TypeError" === n.name) {
                                        if (i.user.id.byteLength < 1 || i.user.id.byteLength > 64) return new c("User ID was not between 1 and 64 characters", "TypeError");
                                    } else if ("UnknownError" === n.name) return new c("The authenticator was unable to process the specified options, or could not create a new credential", "UnknownError");
                                }
                                return n;
                            })({ error: o.sent(), options: n });
                        case 4:
                            ...
                            return (
                                ...
                                (y = {
                                    id: p,
                                    rawId: i(h),
                                    response: { attestationObject: i(w.attestationObject), clientDataJSON: i(w.clientDataJSON) },
                                    type: b,
